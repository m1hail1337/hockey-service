...
public class Result {
    ...
    @Column(name = "id")
    @GenericGenerator(
            name = "fc_tournament_result_id_seq",
            strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @org.hibernate.annotations.Parameter(name = "sequence_name", value = "fc_tournament_result_id_seq"),
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "fc_tournament_result_id_seq")
    private long id;
